...
rnn_nnlm = RnnNNLM(word2index=training_data.word2index, word2vec=word2vec, max_sequence_length=30)
model = rnn_nnlm.train(training_data.sentence_dataset(), nb_epoch=10, samples_per_epoch=1000000)
