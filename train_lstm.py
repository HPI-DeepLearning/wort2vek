...
if __name__ == "__main__":
    ...
    parser.add_argument("-v", "--vectors", dest="vector_file",
        metavar="VECTORS_FILE", required=True, help="File with word vectors, built with gensim.")
    ...
    parser.add_argument("-b", "--batch-size", dest="batch_size",
        metavar="BATCH_SIZE", type=int, help="Number of sentences processed in one batch.")
    parser.add_argument("-r", "--restrict-vocab", dest="restrict_vocab",
        metavar="VOCABS_SIZE", type=int, help="Max vocab size. Can reduce memory consumption heaviliy")
